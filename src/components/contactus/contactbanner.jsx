...
import heroImage from "../../assets/images/contact/contactbanner.png";
    ...
    >
      ...
      <div className="relative z-10 flex bottom-4 items-center justify-start h-screen px-6 md:px-16">
        ...
        >
          ...
          >
            Reach out to us for inquiries, reservations, or personalized guidance for your perfect cottage stay
          </motion.p>
        </motion.div>
      </div>
    </section>
