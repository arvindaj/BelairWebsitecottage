...
import heroImage from "../../assets/images/rooms/roomhero.jpg";
    ...
    >
      ...
      <div className="relative z-10 flex bottom-4 items-center justify-start h-screen px-6 md:px-16">
        ...
        >
          ...
          >
            Indulge in exceptional comfort, personalized service, and elegant living spaces designed for an unforgettable stay
          </motion.p>
        </motion.div>
      </div>
    </section>
