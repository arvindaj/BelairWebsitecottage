...
const ResortContactForm = () => {
  ...
  return (
    <div className="overflow-hidden -mt-15  md:mt-0">
    <div className="min-h-screen lg:mb-20 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl w-full relative">
        <div className="relative">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="h-96 sm:h-[500px] lg:h-[600px] overflow-hidden rounded-lg shadow-xl">
              <img
                src={contactimg}
          ...
          >
            <motion.div
              className="bg-white rounded-lg shadow-xl md:shadow-2xl p-6 sm:p-8 lg:p-12 mx-auto max-w-xl"
